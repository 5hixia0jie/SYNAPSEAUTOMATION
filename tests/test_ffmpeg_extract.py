...
def test_extract_first_frame():
    ...
    # 使用用户的视频文件
    video_path = r"D:\traeProject\SYNAPSEAUTOMATION\syn_backend\videoFile\e16b2aba-6974-4428-b0c4-acff8f34b75c.mp4"
    ...
    try:
        ...
        if os.path.exists(out_path):
            ...
            print(f"✅ 成功提取首帧: {out_path}")
            print(f"✅ 文件大小: {size} bytes")
            print(f"✅ 文件存在: {os.path.exists(out_path)}")
        else:
            print("❌ 未生成输出文件")
